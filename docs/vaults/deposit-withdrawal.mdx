...
<ThemedImage
  alt="Commissions"
  sources={{
    light: useBaseUrl('/img/vault-deposit-flow.png'),
    dark: useBaseUrl('/img/vault-deposit-flow.png'),
  }}
/>
...
<ThemedImage
  alt="Commissions"
  sources={{
    light: useBaseUrl('/img/vault-withdraw-flow.png'),
    dark: useBaseUrl('/img/vault-withdraw-flow.png'),
  }}
/>
...
## Transfers
<!-- TODO: add image of transfer flow -->

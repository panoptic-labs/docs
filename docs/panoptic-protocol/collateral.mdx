...
The Buying Power Reduction of an option depends on 1) the notional value of that option and 2) the price of the underlying asset. 

---

## Collateral requirements for BUYING

The collateral requirements for buying an options depends on the *poolUtilization* according to:
$$

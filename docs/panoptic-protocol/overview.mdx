...
>token0 = ERC20 interface of collateral token
                                                                       _- amount of token0 
                                                                      /    owned by the
    _----------------pp.totalBalance()---------------_               /      Panoptic Pool
   /                                                  \            /
...
-Example 1: poolUtilization = 50%  (targetted equilibrium) 
   _------pp.totalBalance()--+-------------------------_
...
#### Collateralization ration (buying)
...
```
#### Collateralization ration (selling)

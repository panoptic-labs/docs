...
| [Vegoid](https://panoptic.xyz/docs/panoptic-protocol/premium#net-gross-and-owed-fees-with-spread) | This is a vega-like variable that acts as an input into the calculation for the [liquidity spread multiplier](https://panoptic.xyz/docs/faq/#fees).                                                                                                                                                                                                                            | N/A                                                                                                                        | A higher vegoid results in a lower spread, favoring options buyers.                   | A lower vegoid results in a higher spread, favoring options sellers.                     |

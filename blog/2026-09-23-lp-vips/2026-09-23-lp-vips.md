...
---
![](./01.png)
_**5,000 Uniswap LP wallets. 25,000 Season 3 Pips each. Check if yours made the list.**_

---

We identified 5,000 active LP wallets across major Uniswap pools using public onchain data. **Eligible wallets can claim 25,000 Season 3 Pips (Panoptic Points) immediately**. Simply connect to Panoptic to claim them. No deposit or liquidity migration is required.

And that is only the starting point. Eligible LPs can also put their Uniswap positions to work through Panoptic, with the potential to earn additional fees and unlock more Season 3 Pips.
...
And once you’re in, there’s more to explore: Panoptic’s new **unified portfolio** experience brings your supported LP positions, exposure, yield, and risk analytics into one place across Ethereum and Robinhood Chain, giving you a clearer view of how your liquidity is performing and what else you can do with it.


## Introducing Panoptic’s Unified Portfolio Dashboard

Panoptic has launched a new portfolio experience built specifically for onchain liquidity providers. It brings LP positions, portfolio exposure, yield, and risk analytics into one place across Ethereum and Robinhood Chain.
